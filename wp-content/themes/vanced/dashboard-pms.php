...
<body class="g-sidenav-show">
    <nav class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start position-absolute ms-3 bg-white" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="/wp/vanced/dashboard-2/">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <tbody>
    <tr>
      <th scope="row">1</th>
      <td>J-kip</td>
      <td>j-kip@yopmail.com</td>
      <td>
      <select name="choice" id="choice" style="border: 2px solid #090D5A; border-radius: 5px">
...
<nav class = 'menu-left'>
<div class = 'menu'>
<img src = '../wp-content\themes\vanced\assets\img\brand.jpg' alt = '' height="110px">
<hr>
<h4 style="">Vanced Project Manager</h4>
<hr>
<p>
Welcome User
</p>
...
<p>
<a href = '/wp/vanced/dashboard/' title = '' class = 'active'>
...
<p>
<a href = '/wp/vanced/add-project/' title = ''>
...
?></b></td>
<td><b><?php //echo esc_attr( $project_end ) ;
?></b></td>
<td> -->
<!-- <span  -->
<?php// if ( $project_status == 'Pending' ) {
