  ...
  <div class="row justify-content-center">
    ...
    <form action="" method="post" style="width:40vw; box-shadow:3px 3px 3px 3px 3px grey; padding:30px;">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control input-sm mb-4" name="password" id="password" ,
          placeholder="Enter your Password..." style="border: 1px solid #090D5A;" required>
      </div>

      <div class="form-group">
        <label for="password" style="color: #090D5A; font-weight: w800; font-size: 20px">Confirm Password:</label>
        <input type="password" class="form-control input-sm mb-4" name="cpassword" id="password" ,
          placeholder="Confirm Password..." style="border: 1px solid #090D5A;" required>
      </div>
      <div class="btn">
